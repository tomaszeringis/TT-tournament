"""
Adapter for T3Set dataset.
Central coaching/recommendation supervision, video + sensor + coaching text.
"""
...
class T3SetAdapter(BaseAdapter):
    """Adapter for T3Set dataset."""
    ...
    def list_samples(self) -> List[DataSample]:
        ...
        # T3Set has video files with annotations
